...
***
<p>
  <img src="https://courses.cs.washington.edu/courses/cse154/23au/homework/hw2/screenshots/spec-intro-view.png" width="60%" alt="Set! Game board">
</p>
...
page](https://courses.cs.washington.edu/courses/cse154/23au/homework/hw2/hw2.mp4) of the course website.
...
* Below is an example of the message displayed when an incorrect Set is selected:
  ...
  <img src="https://courses.cs.washington.edu/courses/cse154/23au/homework/hw2/screenshots/game-view-not-set.png" width="60%" alt="Not a Set display example">
